...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  ...
  ////CSRF対策
  if (!validateCsrfToken('orders-view')) {
...
<body>
  <div class="container">
    ...
    <table class="table table-bordered table-striped">
      ...
      <tbody> <?php foreach ($order_details as $orders): ?> <tr>
          ...
          <td>
            <form method="post" action="">
              ...
              </select> <?php echo insertCsrfToken('orders-view'); ?> <button type="submit"
                class="btn btn-sm btn-primary">変更</button>
            </form>
          </td>
        </tr>
        <?php endforeach; ?>
      ...
      <table class="table table-bordered table-striped">
        ...
        <tbody> <?php foreach ($order_details as $product): ?> <tr>
